...
declare module "@polkadot/api-base/types/submittable" {
  interface AugmentedSubmittables<ApiType extends ApiTypes> {
    ...
    nftaa: {
       ...
       **/
      proxyCall: AugmentedSubmittable<
        (
          collection: u32 | AnyNumber | Uint8Array,
          item: u32 | AnyNumber | Uint8Array,
    ...
    palletUtility: {
      ...
      dispatchAs: AugmentedSubmittable<
        ...
        [ParachainTemplateRuntimeOriginCaller, Call]
      >;
      /**
       * Dispatches a function call with a provided origin.
       *
    ...
    polkadotXcm: {
       ...
       * making this call.
       **/
      removeAllAuthorizedAliases: AugmentedSubmittable<
        () => SubmittableExtrinsic<ApiType>,
        []
      >;
      /**
    ...
    templatePallet: {
      ...
      doSomething: AugmentedSubmittable<
        (bn: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>,
        [u32]
      >;
      /**
       * Generic tx
