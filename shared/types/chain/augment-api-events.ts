  ...
  interface AugmentedEvents<ApiType extends ApiTypes> {
    ...
    cumulusXcm: {
      ...
      ExecutedDownward: AugmentedEvent<
        ApiType,
        [U8aFixed, StagingXcmV5TraitsOutcome]
      >;
      /**
    ...
    nftaa: {
       ...
       **/
      NFTAACreated: AugmentedEvent<
        ApiType,
        [collection: u32, item: u32, nftAccount: AccountId32],
        { collection: u32; item: u32; nftAccount: AccountId32 }
      >;
      /**
       * An NFTAA's ownership was transferred
       **/
      NFTAATransferred: AugmentedEvent<
        ApiType,
    ...
    templatePallet: {
       ...
       **/
      SomethingStored: AugmentedEvent<
        ApiType,
        [blockNumber: u32, who: AccountId32],
        { blockNumber: u32; who: AccountId32 }
      >;
      /**
       * Generic event
