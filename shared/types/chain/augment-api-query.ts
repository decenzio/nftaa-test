...
import type { BTreeMap, BTreeSet, Bytes, Null, Option, Vec, bool, u128, u16, u32, u64, u8 } from '@polkadot/types-codec';
...
declare module '@polkadot/api-base/types/storage' {
  interface AugmentedQueries<ApiType extends ApiTypes> {
    ...
    nftaa: {
      nftAccounts: AugmentedQuery<ApiType, (arg: ITuple<[u32, u32]> | [u32 | AnyNumber | Uint8Array, u32 | AnyNumber | Uint8Array]) => Observable<Option<AccountId32>>, [ITuple<[u32, u32]>]> & QueryableStorageEntry<ApiType, [ITuple<[u32, u32]>]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    templatePallet: {
       ...
       **/
      something: AugmentedQuery<ApiType, () => Observable<Option<PalletParachainTemplateCompositeStruct>>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
